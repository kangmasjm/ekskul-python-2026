...
projek = int (input("Jumlah Project Selsai : "))

if nilaiKehadiran >= 85 and nilaiSikap == "A" or nilaiSikap =="B" and projek >= 5:
    print ("Magang di Perusahaan Tier-1")
elif nilaiKehadiran >= 85 and nilaiSikap == "A" or nilaiSikap =="B" and projek == 3 or projek == 4:
    print ("Magang di Perusahaan Tier-2")
elif nilaiKehadiran <= 85 and nilaiSikap == "C" or nilaiSikap =="D" and projek < 3:
